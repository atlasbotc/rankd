        ...
        HStack(spacing: MarquiSpacing.sm) {
            Button {
                if let image = generatedImage {
                    ...
                    withAnimation(MarquiMotion.normal) { savedToPhotos = true }
...
struct ListCardView: View {
    ...
    private func medalColor(for rank: Int) -> Color {
        switch rank {
        case 1: return MarquiColors.medalGold
        case 2: return MarquiColors.medalSilver
        case 3: return MarquiColors.medalBronze
